		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-primary">
					...
					<table class="table table-striped table-bordered detail-view hotel">
					
						<g:if test="${hotelInstance?.location}">
						<tr><th>
							<span id="location-label" class="property-label"><g:message code="hotel.location.label" default="Location" /></span></th><td>
						...
						<tr><th>
							<span id="name-label" class="property-label"><g:message code="hotel.name.label" default="Name" /></span></th><td>
					...
					<g:form url="[resource:hotelInstance, action:'delete']" method="DELETE">
						<fieldset class="buttons">
							<g:link class="btn btn-primary edit" action="edit" resource="${hotelInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
