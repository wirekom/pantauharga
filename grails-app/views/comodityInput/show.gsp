        ...
        <div class="panel panel-primary">
            ...
            <table class="table table-striped table-bordered detail-view comodityInput">
                ...
                <g:if test="${comodityInputInstance?.user}">
                    <tr><th>
                        <span id="user-label" class="property-label"><g:message code="comodityInput.user.label"
                                                                                default="User"/></span></th><td>

                        <span class="property-value" aria-labelledby="user-label"><g:link controller="authUser"
                                                                                          action="show"
                                                                                          id="${comodityInputInstance?.user?.id}">${comodityInputInstance?.user?.encodeAsHTML()}</g:link></span>
                ...
                <g:if test="${comodityInputInstance?.region}">
                    <tr><th>
                        <span id="region-label" class="property-label"><g:message code="comodityInput.region.label"
                                                                                  default="Region"/></span></th><td>

                        <span class="property-value" aria-labelledby="region-label"><g:link controller="region"
                                                                                            action="show"
                                                                                            id="${comodityInputInstance?.region?.id}">${comodityInputInstance?.region?.encodeAsHTML()}</g:link></span>
                ...
                <g:if test="${comodityInputInstance?.comodityName}">
                    <tr><th>
                        <span id="comodityName-label" class="property-label"><g:message
                                code="comodityInput.comodityName.label" default="Comodity Name"/></span></th><td>

                        <span class="property-value" aria-labelledby="comodityName-label"><g:link controller="comodity"
                                                                                                  action="show"
                                                                                                  id="${comodityInputInstance?.comodityName?.id}">${comodityInputInstance?.comodityName?.encodeAsHTML()}</g:link></span>
                ...
                <g:if test="${comodityInputInstance?.delta}">
                    <tr><th>
                        <span id="delta-label" class="property-label"><g:message code="comodityInput.delta.label"
                                                                                 default="Delta"/></span></th><td>
                ...
                <g:if test="${comodityInputInstance?.lastUpdated}">
                    <tr><th>
                        <span id="lastUpdated-label" class="property-label"><g:message
                                code="comodityInput.lastUpdated.label" default="Last Updated"/></span></th><td>

                        <span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate
                                date="${comodityInputInstance?.lastUpdated}"/></span>
                ...
                <g:form url="[resource: comodityInputInstance, action: 'delete']" method="DELETE">
                    <fieldset class="buttons">
                        <g:link class="btn btn-primary edit" action="edit"
                                resource="${comodityInputInstance}"><g:message code="default.button.edit.label"
                                                                               default="Edit"/></g:link>
