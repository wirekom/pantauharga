		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-primary">
					...
					<table class="table table-striped table-bordered detail-view restaurant">
					
						<g:if test="${restaurantInstance?.location}">
						<tr><th>
							<span id="location-label" class="property-label"><g:message code="restaurant.location.label" default="Location" /></span></th><td>
							
								<span class="property-value" aria-labelledby="location-label"><g:fieldValue bean="${restaurantInstance}" field="location"/></span>
						...
						<tr><th>
							<span id="name-label" class="property-label"><g:message code="restaurant.name.label" default="Name" /></span></th><td>
					...
					<g:form url="[resource:restaurantInstance, action:'delete']" method="DELETE">
						<fieldset class="buttons">
							<g:link class="btn btn-primary edit" action="edit" resource="${restaurantInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
