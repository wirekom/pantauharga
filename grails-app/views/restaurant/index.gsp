...
<g:set var="entityName"
	value="${message(code: 'restaurant.label', default: 'Restaurant')}" />
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel panel-primary">
				...
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
								...
								<g:sortableColumn property="location" title="${message(code: 'restaurant.location.label', default: 'Location')}" />
					...
					<tbody>
						<g:each in="${restaurantInstanceList}" status="i"
							...
							<tr>
								...
								<td><g:link action="show" id="${restaurantInstance.id}">${fieldValue(bean: restaurantInstance, field: "location")}</g:link></td>
				...
				<g:paginate total="${restaurantInstanceCount ?: 0}" class="pull-right" />
			</div>
		</div>
	</div>
</body>
