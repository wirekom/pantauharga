	...
	<body>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<g:hasErrors bean="${pasarInstance}">
				<ul class="alert alert-danger" role="alert">
					<g:eachError bean="${pasarInstance}" var="error">
					<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
					</g:eachError>
				</ul>
				</g:hasErrors>
				<g:form url="[resource:pasarInstance, action:'update']" method="PUT"  role="form">					
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<g:hiddenField name="version" value="${pasarInstance?.version}" />
