...
<html>
	...
	<body>
		<a href="#list-comodityType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-comodityType" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<tbody>
				<g:each in="${comodityTypeInstanceList}" status="i" var="comodityTypeInstance">
			...
			<div class="pagination">
				<g:paginate total="${comodityTypeInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
