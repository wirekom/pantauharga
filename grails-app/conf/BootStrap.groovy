...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        if (grailsApplication.config.dataSource.dbCreate == "create-drop") {
            ...
            def guestRole = new AuthRole(authority: 'ROLE_GUEST').save(flush: true)
            ...
            def guestUser = new AuthUser(username: 'guest', nama: 'guest', enabled: true, password: 'guest', email: 'guest@gmail.com', nohp: '8098080988').save(flush: true)

            AuthUserAuthRole.create guestUser, guestRole, true
